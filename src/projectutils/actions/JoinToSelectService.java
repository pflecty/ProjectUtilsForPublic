...
/**
 * 跳转到选中Service
 * 比如鼠标选中控制类EntryOrdersController@RequestMapping("/entryOrders")那么跳转到EntryOrdersService处
 * @author Administrator
 */
public class JoinToSelectService implements IWorkbenchWindowActionDelegate {
	private IWorkbenchWindow window;
	private PositionUtil positionUtil = null;
	
	public JoinToSelectService() {
	...
	public void run(IAction action) {
		...
		clooseText = CommonUtil.toUpperCaseFirstOne(clooseText) + "Service";
